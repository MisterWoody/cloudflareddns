# cloudflareddns
This Rust program allows you to use the free CloudFlare DNS service as a dynamic DNS provider. It provides functions to get your external IPv4 and IPv6 addresses, get the ID of a DNS zone, and create or update a DNS record in that zone.

This is a refactoring and update of [Dylan Taylor's CloudflareDDNS-Rust] (https://github.com/dylanmtaylor/cloudflareddns-rust) project
## Usage

To use this program, you will need a CloudFlare API Token with Update DNS record permissions. You can find instructions for how to generate an API token in the CloudFlare documentation.
